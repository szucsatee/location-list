# Azure Elérhető Régiók Listája (Location List)

Ez a leírás az Azure CLI segítségével lekérdezhető elérhető régiókat és azok pontos azonosítóit tartalmazza.

## 🔍 Lekérdező parancs

Az alábbi parancs futtatásával listázhatod ki az elérhető helyszíneket táblázatos formában:
...
## 🗺️ Elérhető régiók táblázata

| DisplayName | Name (CLI ID) | RegionalDisplayName |
| :--- | :--- | :--- |
...
| East US 2 (Stage) | eastus2stage | (US) East US (Stage) |
